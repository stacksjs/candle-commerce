...
var resolveCredentialSource = (credentialSource, profileName, logger) => {
  const sourceProvidersMap = {
    EcsContainer: async (options) => {
      const { fromHttp } = await import("./chunk-vra1ncmq.js");
    ...
    Environment: async (options) => {
      ...
      const { fromEnv } = await import("./chunk-1n9mxrp7.js");
...
var resolveAssumeRoleCredentials = async (profileName, profiles, options, visitedProfiles = {}) => {
  ...
  if (!options.roleAssumer) {
    const { getDefaultRoleAssumer } = await import("./chunk-er7tcbp4.js");
...
var resolveProcessCredentials = async (options, profile) => import("./chunk-scm6043k.js").then(({ fromProcess }) => fromProcess({
  ...options,
  profile
...
var resolveSsoCredentials = async (profile, profileData, options = {}) => {
  const { fromSSO } = await import("./chunk-zhgp308m.js");
  return fromSSO({
    profile,
...
var resolveWebIdentityCredentials = async (profile, options) => import("./chunk-5s0w5n7p.js").then(({ fromTokenFile }) => fromTokenFile({
