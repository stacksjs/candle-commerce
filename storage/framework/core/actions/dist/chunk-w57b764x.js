...
var resolveCredentialSource = (credentialSource, profileName, logger) => {
  const sourceProvidersMap = {
    EcsContainer: async (options) => {
      ...
      const { fromContainerMetadata } = await import("./chunk-mgjy4dwe.js");
    ...
    Ec2InstanceMetadata: async (options) => {
      ...
      const { fromInstanceMetadata } = await import("./chunk-mgjy4dwe.js");
      return async () => fromInstanceMetadata(options)().then(setNamedProvider);
    },
    Environment: async (options) => {
      logger?.debug("@aws-sdk/credential-provider-ini - credential_source is Environment");
      const { fromEnv } = await import("./chunk-55w3c74x.js");
...
var resolveAssumeRoleCredentials = async (profileName, profiles, options, visitedProfiles = {}) => {
  ...
  if (!options.roleAssumer) {
    const { getDefaultRoleAssumer } = await import("./chunk-1j57w91x.js");
...
var resolveProcessCredentials = async (options, profile) => import("./chunk-m7ygbbgr.js").then(({ fromProcess }) => fromProcess({
  ...options,
  profile
...
var resolveWebIdentityCredentials = async (profile, options) => import("./chunk-2ea0xrr4.js").then(({ fromTokenFile }) => fromTokenFile({
