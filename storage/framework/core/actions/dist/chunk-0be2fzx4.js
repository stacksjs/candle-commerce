  ...
  for (const iniLine of iniData.split(/\r?\n/)) {
    ...
    if (isSection) {
      ...
      if (matches) {
        ...
        if (Object.values(import_types2.IniSectionType).includes(prefix)) {
...
// ../../../../node_modules/@smithy/shared-ini-file-loader/dist-es/getSsoSessionData.js
var getSsoSessionData = (data) => Object.entries(data).filter(([key]) => key.startsWith(import_types3.IniSectionType.SSO_SESSION + CONFIG_PREFIX_SEPARATOR)).reduce((acc, [key, value]) => ({ ...acc, [key.substring(key.indexOf(CONFIG_PREFIX_SEPARATOR) + 1)]: value }), {});
