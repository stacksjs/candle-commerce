// @bun
import"./chunk-2g57f3kb.js";var E=Object.freeze({displayName:"DAX",name:"dax",patterns:[{include:"#comments"},{include:"#keywords"},{include:"#labels"},{include:"#parameters"},{include:"#strings"},{include:"#numbers"}],repository:{comments:{patterns:[{begin:"//",captures:{"0":{name:"punctuation.definition.comment.dax"}},end:`
