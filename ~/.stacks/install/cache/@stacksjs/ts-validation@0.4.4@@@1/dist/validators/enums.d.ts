...
export declare class EnumValidator<T extends string | number> extends BaseValidator<T> implements EnumValidatorType<T> {
...
export declare function enum_<T extends string | number>(allowedValues: readonly T[]): EnumValidator<T>;