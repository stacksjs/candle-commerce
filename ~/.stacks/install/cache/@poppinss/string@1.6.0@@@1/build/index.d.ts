...
declare const string: {
    ...
    seconds: {
        format(seconds: number, long?: boolean): import("./src/types.js").PrettyTime;
        parse(duration: string | number): number;
    };
    milliseconds: {
        format(milliseconds: number, long?: boolean): import("./src/types.js").PrettyTime;
        parse(duration: string | number): number;
    };
    bytes: {
        format(valueInBytes: number, options?: import("bytes").BytesOptions): import("./src/types.js").PrettyBytes | null;
