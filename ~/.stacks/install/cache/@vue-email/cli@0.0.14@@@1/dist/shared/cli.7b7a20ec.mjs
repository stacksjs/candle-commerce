...
const name = "@vue-email/cli";
const type = "module";
const version = "0.0.14";
const packageManager = "pnpm@8.11.0";
const description = "⚡️ Vue Email Generation CLI Experience";
const author = "Younes Barrad <younesbarraddev@gmail.com>";
const license = "MIT";
const maintainers = [
	{
		name: "Dave136",
...
const homepage = "https://vuemail.net/plugins/cli";
const repository = {
	type: "git",
	url: "git+https://github.com/vue-email/cli.git"
};
const bugs = "https://github.com/vue-email/cli/issues";
const keywords = [
	"vue",
	"vue-email",
	"templates",
...
const commands = {
  export: () => import('../chunks/export.mjs').then(_rDefault)
};
...
export { colors as a, consola as c, defineCommand as d, getDefaultExportFromCjs as g, isUnicodeSupported as i, main as m, runMain as r };
