...
declare const ViewBillingCommand_base: {
    new (input: ViewBillingCommandInput): import("@smithy/smithy-client").CommandImpl<ViewBillingCommandInput, ViewBillingCommandOutput, Route53DomainsClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (...[input]: [] | [ViewBillingCommandInput]): import("@smithy/smithy-client").CommandImpl<ViewBillingCommandInput, ViewBillingCommandOutput, Route53DomainsClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
