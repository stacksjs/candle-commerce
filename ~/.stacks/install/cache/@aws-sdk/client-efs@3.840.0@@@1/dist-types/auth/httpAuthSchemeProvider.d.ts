 ...
 * @internal
 */
export interface EFSHttpAuthSchemeParametersProvider extends HttpAuthSchemeParametersProvider<EFSClientResolvedConfig, HandlerExecutionContext, EFSHttpAuthSchemeParameters, object> {
}
/**
 * @internal
 */
export declare const defaultEFSHttpAuthSchemeParametersProvider: (config: EFSClientResolvedConfig, context: HandlerExecutionContext, input: object) => Promise<EFSHttpAuthSchemeParameters>;
/**
 * @internal
 */
