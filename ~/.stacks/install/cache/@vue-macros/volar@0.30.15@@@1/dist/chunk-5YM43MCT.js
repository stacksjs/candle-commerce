...
function transformDefineModels(options) {
  ...
  if (ts.isTypeLiteralNode(typeArg) && typeArg.members) {
    for (const member of typeArg.members) {
      if (ts.isPropertySignature(member) && member.type) {
        const type = _chunk6LLWWLOSjs.getText.call(void 0, member.type, options);
        let name = _chunk6LLWWLOSjs.getText.call(void 0, member.name, options);
  ...
  _chunk6LLWWLOSjs.addProps.call(void 0, codes, propStrings, vueLibName);
  _chunk6LLWWLOSjs.addEmits.call(void 0, codes, emitStrings, vueLibName);
}
