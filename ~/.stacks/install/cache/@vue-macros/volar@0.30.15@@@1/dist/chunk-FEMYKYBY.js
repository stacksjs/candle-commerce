...
var plugin = _tsmacro.createPlugin.call(void 0, 
  ({ ts, vueCompilerOptions }, options = _optionalChain([vueCompilerOptions, 'optionalAccess', _3 => _3.vueMacros, 'optionalAccess', _4 => _4.jsxRef]) === true ? {} : _nullishCoalesce(_optionalChain([vueCompilerOptions, 'optionalAccess', _5 => _5.vueMacros, 'optionalAccess', _6 => _6.jsxRef]), () => ( {}))) => {
    if (!options) return [];
