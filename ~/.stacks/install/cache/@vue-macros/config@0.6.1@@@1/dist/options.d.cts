...
declare function resolveOptions(options?: Options, cwd?: string, config?: Omit<Options, "plugins">): OptionsResolved;
declare function resolveOptionsAsync(options?: Options, cwd?: string): Promise<OptionsResolved>;

export { type FeatureName, type FeatureOptions, type FeatureOptionsMap, type Options, type OptionsCommon, type OptionsResolved, resolveOptions, resolveOptionsAsync };
